...
const SearchForm = () => {
    const { setSearchTaskTitle, searchTaskTitle } = useContext(UiContext);

    return (
        <form className="todo__search-form search-form" onSubmit={(event) => event.preventDefault()}>
            <label className="search-form__label visually-hidden" 
