...
const ItemControls = (props: ItemControlsProps) => {
    ...
    return (
        <div className={className}>
            <button className={`${styles.buttons} ${styles.buttonEdit} button-reset`} 
                type="button"
                aria-label="Edit"
                title="Edit"
                disabled={animation.deleatingTasks.includes(taskId)}
            ...
            <button className={`${styles.buttons} ${styles.buttonDelete} button-reset`}
                type="button"
                aria-label="Deleate"
                title="Deleate"
                disabled={animation.deleatingTasks.includes(taskId)}
